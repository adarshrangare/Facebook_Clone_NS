...
const CreatePost = () => {
  ...
  return (
    <>
      <section className="max-w-xl max-lg:max-w-lg max-md:max-w-md w-full mx-auto p-4 pb-2 bg-primary-light dark:bg-primary-dark shadow rounded-md">
        ...
        <div className="flex  justify-between pt-3">
          <div
            onClick={openModal}
            className="flex flex-1 justify-center items-center gap-2 rounded-md hover:bg-hover-light dark:hover:bg-hover-dark w-fit p-2 py-3 cursor-pointer text-sm font-semibold text-neutral-500 dark:text-neutral-400"
          >
          ...
          <div
            onClick={openModal}
            className="flex flex-1 justify-center items-center gap-2 rounded-md hover:bg-hover-light dark:hover:bg-hover-dark w-fit px-1 py-3 cursor-pointer text-sm font-semibold text-neutral-500 dark:text-neutral-400"
          >
